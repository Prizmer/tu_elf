...
namespace Drivers.ElfApatorDriver
{
    /// <summary>
    ...
    public class ElfApatorDriver : CMeter, IMeter
    {
                ...
                case Params.ENERGY:
                    {
                        ...
                        //согласно письму, которое прислал Женя 08.08.17 (верно согласно ElfTest kWh)
    ...
    public class ArchiveValueParser : ElfApatorDriver
    {
            #region Объявления
